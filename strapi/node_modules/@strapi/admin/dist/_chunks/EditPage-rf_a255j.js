...
const useWebhooks = require("./useWebhooks-nFFf0Nl-.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-SMVq4K27.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-rf_a255j.js.map
