...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-KlaImB-Z.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/permissions": "4.25.24",
  "@strapi/provider-audit-logs-local": "4.25.24",
  "@strapi/types": "4.25.24",
  "@strapi/typescript-utils": "4.25.24",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.24",
  "@strapi/data-transfer": "4.25.24",
  "@strapi/pack-up": "4.23.0",
  "@strapi/plugin-content-manager": "4.25.24",
...
const CM = React.lazy(
  () => import("./index-KlaImB-Z.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-iGGPufdI.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-FLV-i16T.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-9gMDs0VU.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-KlaImB-Z.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-31ZnqdJz.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-ge7YVBZh.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-9hmvxLus.mjs.map
