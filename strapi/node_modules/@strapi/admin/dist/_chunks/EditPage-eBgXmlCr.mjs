...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-KlaImB-Z.mjs";
...
import { u as useWebhooks } from "./useWebhooks-m2S17Isk.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-OjN46vKG.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-eBgXmlCr.mjs.map
