...
const ListView$1 = lazy(() => import("./ListView-UKpocBAL.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-UKpocBAL.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-9vx-89h9.mjs.map
