"use strict";(self.webpackChunktropa_nartov_strapi=self.webpackChunktropa_nartov_strapi||[]).push([[9535],{19535:(dt,S,s)=>{s.r(S),s.d(S,{default:()=>Nt});var t=s(92132),_=s(94061),P=s(85963),X=s(58805),F=s(88353),G=s(4198),w=s(55356),m=s(83997),N=s(35513),C=s(26127),z=s(90361),I=s(33363),ct=s(40216),E=s(30893),d=s(69593),ht=s(46270),_t=s(54514),pt=s(68802),gt=s(77701),ut=s(41231),J=s(41909),W=s(5194),mt=s(50612),D=s(2600),Et=s(412),Y=s(56336),q=s(39404),R=s(54894),H=s(17703),L=s(21272),r=s(365),f=s(63891),kt=s(14718),Zt=s(84819),Vt=s(48940),Xt=s(77160),Gt=s(21835),wt=s(17024),Ht=s(51187),Qt=s(12083),Jt=s(94710),Yt=s(14311),qt=s(82437),te=s(89102),ee=s(5409),se=s(35336),ne=s(71547),oe=s(58692),ae=s(71210),ie=s(5790),le=s(35223),re=s(45635);const ft=(0,f.Ay)(_.a)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,m=(0,_.Ay)(P.a)`
  ...
  width: 100%;
  border: none;
`,N=({children:C,icon:z,...I})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(X.c,{}),(0,t.jsx)(m,{as:"button",background:"primary100",padding:5,...I,children:(0,t.jsxs)(F.s,{children:[(0,t.jsx)(w,{"aria-hidden":!0,background:"primary200",children:z}),(0,t.jsx)(P.a,{paddingLeft:3,children:(0,t.jsx)(G.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:C})})]})})]})}}]);
